...
public class ViewMahasiswa extends javax.swing.JFrame {
    ...
    public ViewMahasiswa() {
        initComponents();
        tablelist.setModel(mhs.showData()); // Set model tabel saat inisialisasi frame
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DATA PENGGUNA BARU");
    ...
    private void daftarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_daftarActionPerformed
        ...
        String passwordku = password.getText();
        
        mhs.InsertData(idku,passwordku);
